...
int main(int argc, char *argv[]) {
  ...
  int temp1 = openat(AT_FDCWD, "/tmp/copy_file_range_test", O_WRONLY|O_CREAT|O_TRUNC, 0100644);
  ...
  int dest = openat(AT_FDCWD, "destination", O_WRONLY|O_CREAT|O_TRUNC, 0100644);
